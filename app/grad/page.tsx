...
export default function GradPage() {
  // Gallery items — graduation portraits
  const galleryItems = [
    { id: 1,  type: "image", src: "/images/grad-gallery/grad-01.webp", alt: "Graduation portrait with bubbles at UCLA" },
    { id: 2,  type: "image", src: "/images/grad-gallery/grad-02.webp", alt: "Confetti popper graduation portrait at CSU Fullerton" },
    { id: 3,  type: "image", src: "/images/grad-gallery/grad-03.webp", alt: "Classic USC graduation portrait at Tommy Trojan" },
    {
      id: 4,
      type: "video",
      src: "https://rvideo.b-cdn.net/headshot-website-videos/headshot-photographer-portland-oregon.mp4",
      poster: "/images/grad-gallery/grad-01.webp",
      name: "Erica Carnrite",
    ...
    { id: 5,  type: "image", src: "/images/grad-gallery/grad-04.webp", alt: "Graduation portrait photography" },
    { id: 6,  type: "image", src: "/images/grad-gallery/grad-05.webp", alt: "UCLA creative graduation portrait at Powell Library" },
    { id: 7,  type: "image", src: "/images/grad-gallery/grad-06.webp", alt: "LMU graduation portrait in full cap and gown" },
    {
      id: 8,
      type: "video",
      src: "https://rvideo.b-cdn.net/headshot-website-videos/mark%20headshot%20testimonial.mp4",
      poster: "/images/grad-gallery/grad-02.webp",
      name: "Mark Johnson",
      title: "Business Development Manager",
      quote: "I needed new professional headshots and Nathan's work is absolute fantastic! The shoot was fun, relaxed, and Nathan captured my vision, he is a fantastic photographer!",
    },
    { id: 9,  type: "image", src: "/images/grad-gallery/grad-07.webp", alt: "Traveler horse statue USC graduation portrait" },
    { id: 10, type: "image", src: "/images/grad-gallery/grad-08.webp", alt: "UCLA Shapiro Fountain graduation portrait" },
    { id: 11, type: "image", src: "/images/grad-gallery/grad-09.webp", alt: "Graduation portrait photography" },
    { id: 12, type: "image", src: "/images/grad-gallery/grad-10.webp", alt: "Cap and sash Pepperdine University graduation portrait" },
    {
      id: 13,
      type: "testimonial",
      name: "Tom Danowski",
    ...
    },
    {
      ...
      text: "Click here to get a quick and easy quote for your graduation portrait session",
    ...
    },
    {
      ...
      poster: "/images/grad-gallery/grad-03.webp",
      name: "Emily Walton",
      title: "Marketing Specialist, Creative Solutions",
      quote: "I needed new professional headshots and Nathan's work is absolute fantastic! The shoot was fun, relaxed, and Nathan captured my vision, he is a fantastic photographer!",
    },
    { id: 16, type: "image", src: "/images/grad-gallery/grad-11.webp", alt: "Graduation portrait sitting by fountain at USC" },
    { id: 17, type: "image", src: "/images/grad-gallery/grad-12.webp", alt: "Confident graduate walking Janss Steps at UCLA" },
    { id: 18, type: "image", src: "/images/grad-gallery/grad-13.webp", alt: "Epic Royce Hall night graduation portrait" },
    { id: 19, type: "image", src: "/images/grad-gallery/grad-14.webp", alt: "Graduation portrait in long white chiffon dress" },
    { id: 20, type: "image", src: "/images/grad-gallery/grad-15.webp", alt: "UCLA group graduation photo at Shapiro Fountain" },
    { id: 21, type: "image", src: "/images/grad-gallery/grad-16.webp", alt: "Graduation portrait photography" },
    { id: 22, type: "image", src: "/images/grad-gallery/grad-17.webp", alt: "Graduation portrait photography" },
    { id: 23, type: "image", src: "/images/grad-gallery/grad-18.webp", alt: "Confetti poppers group graduation portrait at USC" },
    { id: 24, type: "image", src: "/images/grad-gallery/grad-19.webp", alt: "High fashion graduation portraits at Cal Poly Pomona" },
    { id: 25, type: "image", src: "/images/grad-gallery/grad-20.webp", alt: "Graduation portrait photography" },
    {
      id: 26,
      type: "cta",
      title: "Book Your Session",
      text: "Ready to schedule? Book your graduation portrait session directly on our calendar",
      url: "https://ww3.headshotportland.com/instant",
      color: "green",
    },
    { id: 27, type: "image", src: "/images/grad-gallery/grad-21.webp", alt: "UC Santa Barbara sunset graduation portrait" },
    { id: 28, type: "image", src: "/images/grad-gallery/grad-22.webp", alt: "Graduation portrait photography" },
    { id: 29, type: "image", src: "/images/grad-gallery/grad-23.webp", alt: "Graduation portrait photography" },
  ]
          ...
          <div className="w-full text-white py-16 md:py-24">
            <div className="container mx-auto text-center">
              <h1 className="font-bodoniModa text-4xl md:text-5xl lg:text-6xl mb-6 tracking-wide">
                GRADUATION PORTRAIT GALLERY
              </h1>
              <p className="font-playfair text-xl md:text-2xl mb-12">Celebrate your achievement with stunning graduation portraits</p>
