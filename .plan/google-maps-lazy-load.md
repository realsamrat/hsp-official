...
description: Lazy-load Google Maps iframe on homepage by replacing with static image and click-to-load interaction to reduce initial page load by 409 KiB JS and 180ms main thread time
---
